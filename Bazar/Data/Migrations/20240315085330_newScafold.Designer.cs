...
namespace Bazar.Data.Migrations
{
    ...
    [Migration("20240315085330_newScafold")]
    partial class newScafold
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bazar.Data.Models.Ad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bazar.Data.Models.AdBuyer", b =>
                {
            ...
            modelBuilder.Entity("Bazar.Data.Models.AdBuyer", b =>
                {
                    b.HasOne("Bazar.Data.Models.Ad", "Ad")
                        .WithMany()
                        .HasForeignKey("AdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
